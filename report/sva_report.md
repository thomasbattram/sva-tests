...
![Figure 2: How does time taken to perform SVA vary with number of SVs and distribution of phenotype (continuous or binary)?](figure/time_plot2-1.png)

![Figure 3: How does time taken to perform SVA vary with alpha and B values?](figure/model_param_time_plot-1.png)
...
![Figure 4: Is it better to subset the number of CpGs randomly or by most variable CpGs when running SVA?](figure/mv_vs_random-1.png)

Number of CpGs is set to 20,000

![Figure 5: Variance captured of SVs made using 450k CpGs by all SVs made using random subsets of varying numbers of CpGs](figure/ncpg_plot-1.png)

![Figure 6: Variance captured of SVs made using EPIC array CpGs by all SVs made using random subsets of varying numbers of CpGs](figure/ncpg_plot_850k-1.png)

### Variance explained of covariates by SVs

![Figure 7: Number of SVs required estimated using num.sv() and random matrix theory](figure/est_num_plot-1.png)

![Figure 8: Variance of important covariates explained by SVs](figure/covs_var_exp-1.png)
