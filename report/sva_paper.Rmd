...
## Results
The correlation between each of 20 SVs produced by the SmartSVA and SVA package was 1 or -1 (__`r sup_table_nums("", display = "cite")`__) and the time taken by SmartSVA was on average X times faster (__`r fig_nums("", display = "cite")`__). 
